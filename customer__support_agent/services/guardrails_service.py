...
class AccountNumberValidator(Validator):
    ...
    def validate(self, value:Any,metadata: dict[str, Any]) -> Any:
        ...
        return FailResult(
            ...
            fix_value=fixed,
            metadata={"entity_type": ["ACCOUNT_NUMBER"], "count": len(matches)},
        )
...
class RegexPiiValidator(Validator):
    ...
    def validate(self, value: Any,metadata:dict[str,Any]) -> Any:
        ...
        return FailResult(
            ...
            fix_value=sanitized,
            metadata={"entity_type": entities, "count": total},
        )
...
class GuardrailsService:
    ...
    def sanitize_text(self,text:str) -> tuple[str, list[str,Any]]:
        ...
        for validator in self._pii_validators:
            ...
            if isinstance(result, FailResult):
                ...
                entity_types = list(metadata.get("entity_type") or [])
    ...
    def _classify_scope(self,text:str) -> dict[str, str]:
        ...
        llm_label = self._classify_scope_with_llm(text)
    ...
    def _classify_scope_with_llm(self, text:str) -> str:
        ...
        system_prompt = (
            ...
            "OFF_TOPIC means it asks for unrelated create writing, entertainment, recipes,"
